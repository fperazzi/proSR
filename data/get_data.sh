...
# ProSRs
wget -nc https://www.dropbox.com/s/ldv397lcr3vn95w/proSRs.zip?dl=0 -O /tmp/proSRs.zip
unzip -j /tmp/proSRs.zip -d $DATADIR/checkpoints && rm /tmp/proSRs.zip

# ProSR
wget -nc https://www.dropbox.com/s/3fjp5dd70wuuixl/proSR.zip?dl=0 -O /tmp/proSR.zip
unzip -j /tmp/proSR.zip -d $DATADIR/checkpoints && rm /tmp/proSR.zip

# ProSRGAN
wget -nc https://www.dropbox.com/s/ulkvm4yt5v3vxd8/proSRGAN.zip?dl=0 -O /tmp/proSRGAN.zip
...
wget -nc https://www.dropbox.com/s/uvwtxy5hul90hyl/DIV2KX8.zip?dl=0 -O /tmp/DIV2KX8.zip
