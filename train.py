...
def parse_args():
    ...
    parser.add_argument('--name',        type=str, help='name of this training experiment', default=strftime("%Y-%m-%d_%H:%M:%S", gmtime()))
...
def main(opt):
    ...
    print('#training images = %d' % len(training_dataset))
    ...
    print('#validation images = %d' % len(testing_dataset))
